...
public :
	...
	huq_entry (/*const uint64_t& pc1,*/ const uint64_t& branchTarget1, const bool& resolveDir1)
	: /*predDir {pc {pc1},*/ branchTarget {branchTarget1}, resolveDir{resolveDir1}
	{	
	}
	
	// Move assignment since queue must contain entire huq_entry (not just pointer), since allocated entry will get "destructed" 
